        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Button
              ...
              asChild
            >
              <a href="https://partners.deriv.com/rx?sidc=1AB8D3B0-5B0E-4201-904F-DCE3E7612BBC&utm_campaign=dynamicworks&utm_medium=affiliate&utm_source=CU102488" target="_blank" rel="noopener noreferrer">
                Log in
              </a>
            </Button>
            <Button
              ...
              asChild
            >
              <a href="https://partners.deriv.com/rx?sidc=D4A4D5DC-8F9D-4AE9-AFA9-F9D789A36C84&utm_campaign=dynamicworks&utm_medium=affiliate&utm_source=CU102488" target="_blank" rel="noopener noreferrer">
                Sign up
              </a>
            </Button>
          </div>
